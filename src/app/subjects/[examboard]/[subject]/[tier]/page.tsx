...
export default function SubjectProgressPage() {
  ...
  const allPapers = getPapersBySubjectAndBoard(examBoard, `${subject}-${tier.toLowerCase()}`);
  const subjectName = getSubjectNameFromId(`${subject}-${tier.toLowerCase()}`, examBoard);
