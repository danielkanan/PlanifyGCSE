  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="fixed bottom-6 right-6">
        <div className="w-14 h-14 bg-primary rounded-full flex items-center justify-center text-primary-foreground shadow-lg cursor-pointer hover:scale-105 transition-transform">
